<template>
    <div class="">
        <div class="row bg-white q-mt-xs-md q-mt-md-lg full-width items-center">
            <div class="col-xs-12 col-md-5 bg-grey-5 row justify-center items-center font-h1" style="height:350px">
                Image
            </div>
